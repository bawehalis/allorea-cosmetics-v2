...
const NAV_ITEMS = [
  ...
  { label: 'Koleksiyonlar', href: '/shop?featured=true', children: [
    { label: 'Yeni Gelenler', href: '/shop?sort=newest' },
    { label: 'En Çok Satanlar', href: '/shop?sort=bestseller' },
    { label: 'Hediye Setleri', href: '/shop?tag=gift' },
    { label: 'İndirim', href: '/shop?sale=true' },
  ]},
  ...
  return (
    <>
      ...
      <div className="announcement-bar">
        <p>Free shipping on orders over $75 · Use code <strong>ALLOREA15</strong> for 15% off your first order</p>
      </div>
