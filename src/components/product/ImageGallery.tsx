      ...
      <div className="flex gap-4">
          ...
          <div className="hidden sm:flex flex-col gap-2.5 w-[72px] shrink-0">
            {images.map((img, i) => (
              <button
                ...
                className={cn(
                  'relative w-[72px] h-[86px] overflow-hidden border-2 transition-all duration-150',
        ...
        <div className="flex-1">
          <div
            ref={imgRef}
            className={cn(
              'relative aspect-square overflow-hidden bg-nude-50 cursor-zoom-in select-none',
          ...
          >
            ...
            {images.length > 1 && (
              <>
                <button
                  onClick={prev}
                  className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-12 w-10 h-10 flex items-center justify-center text-white hover:text-nude-300 transition-colors"
                >
                  <ChevronLeft size={24} />
                </button>
                <button
                  onClick={next}
                  className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-12 w-10 h-10 flex items-center justify-center text-white hover:text-nude-300 transition-colors"
                >
            ...
            {images.map((_, i) => (
              <button
                ...
                className={cn(
                  ...
                  i === selected ? 'w-6 h-1.5 bg-white' : 'w-1.5 h-1.5 bg-white/40'
                )}
              />
            ))}
          </div>
