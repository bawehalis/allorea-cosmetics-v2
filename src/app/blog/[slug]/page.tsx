    ...
    <div className="bg-pearl min-h-screen">
      <div className="container-main py-10 max-w-3xl">
        <nav className="font-body text-xs text-nude-400 mb-8">
          <Link href="/" className="hover:text-charcoal">Home</Link> / <Link href="/blog" className="hover:text-charcoal">Journal</Link> / <span className="text-charcoal">{post.title}</span>
        </nav>
