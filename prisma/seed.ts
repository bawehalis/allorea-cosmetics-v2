...
async function main() {
  ...
  // ─── SiteConfig (urgency + content ayarları) ─────────────────────────────
  const configs = [
    { key:'urgency.buyers24hEnabled',    value:'true'  },
    { key:'urgency.buyers24hCount',      value:'128'   },
    { key:'urgency.stockWarningEnabled', value:'true'  },
    { key:'urgency.stockWarningThreshold',value:'20'  },
    { key:'urgency.viewersEnabled',      value:'true'  },
    { key:'urgency.viewersCount',        value:'23'    },
    { key:'content.heroTitle',           value:'Saç Dökülmesini\nDurdurun.' },
    { key:'content.heroCta',             value:'Hemen Sipariş Ver' },
    { key:'content.beforeUrl',           value:'https://images.unsplash.com/photo-1522338242992-e1a54906a8da?auto=format&fit=crop&w=800&q=80' },
    { key:'content.afterUrl',            value:'https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?auto=format&fit=crop&w=800&q=80' },
  ]
  ...
  console.log(`✅ ${configs.length} site konfigürasyonu oluşturuldu`)
